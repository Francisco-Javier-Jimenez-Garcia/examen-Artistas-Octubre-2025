...
const artistswithusersAPI_auto = {

    /** Gets all entries from 'artistswithusers' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/artistswithusers`, requestOptions);
        return response.data;
    },
};

export { artistswithusersAPI_auto };